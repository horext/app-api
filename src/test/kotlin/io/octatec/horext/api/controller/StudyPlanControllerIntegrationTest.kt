...
class StudyPlanControllerIntegrationTest(
    ...
    @Test
    fun studyPlansEndpointShouldReturnJsonFromDatabaseQuery() {
        mockMvc
            .perform(get("/studyPlans"))
            .andExpect(handler().handlerType(StudyPlanController::class.java))
            .andExpect(handler().methodName("getAllStudyPlans"))
            .andExpect { result ->
                assertTrue(
